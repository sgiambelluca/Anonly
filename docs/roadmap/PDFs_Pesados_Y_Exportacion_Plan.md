...
Este plan implementa el punto 3 de `Optimizacion_De_Memoria_Plan.md` §2ter y la decisión de ADR-180. La entrega es un banco opt-in y un informe de corridas, no una optimización del producto.
