...
> opt-in de ADR-179 y `NER_Engine.md` §12–§15: B redujo WASM, pero sin ventaja
> RSS atribuible; se conserva A (`Empaquetado_NER_Medicion.md`). El punto 3
> tiene documentación cerrada por ADR-180 y
...
ADR-179 fija un único brazo comparable: el ONNX Q8 actual frente al mismo
...
evaluación futura favorable requeriría una enmienda previa de ADR-179 y del
spec para distribuir el derivado.

Después de la revisión del punto 2, comparar la carga actual con la alternativa
de datos externos fijada por ADR-179, **sin cambiar modelo, pesos, cuantización ni
...
**Documentación cerrada para implementar el banco el 2026-09-23** (ADR-180 y
