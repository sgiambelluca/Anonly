...
Además choca con R-1/R-5 ("un PR = un módulo"): adoptar una utilidad compartida en cinco motores son cinco PRs, salvo que un ADR autorice explícitamente el cambio multi-motor.
