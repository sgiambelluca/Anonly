...
`[PERSONA 01]` sobre "Eta" es el caso canónico: 11 caracteres sobre una caja de 3.
...
| **Solo dos niveles** | El humano pidió tres explícitamente. Con dos, `[PERS 01]` sobre "Eta" o "Luz" sigue sin entrar, que es justamente el caso que motivó el reporte. |
