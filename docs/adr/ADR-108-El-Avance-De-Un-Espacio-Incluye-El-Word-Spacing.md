...
|---|---|---|
| pericia PERICIA_A | **961/1560 (61,6 %)** | 261 (16,7 %) |
| pericia PERICIA_B | **1579/2648 (59,6 %)** | 379 (14,3 %) |
...
| variante | pericia PERICIA_A | pericia PERICIA_B | cuento |
|---|---|---|---|
...
|---|---|
| pericia PERICIA_A | 5 → **0** |
| pericia PERICIA_B | 3 → **0** |
| cuento | 7 → **0** |
...
`alignToGlyphs` sabe saltear un espacio **de la cadena** que el flujo no tiene (ADR-102 §2: los que pdf.js sintetiza), pero no el caso simétrico. Son 4 items en la pericia y 3 en la pericia PERICIA_B.
...
|---|---|---|---|
| pericia PERICIA_A | **13 → 2** | 965/1560 → **7** | 264 → **7** |
| pericia PERICIA_B | **38 → 0** | 1591/2647 → **23** | 384 → **25** |
...
|---|---|---|
| pericia PERICIA_A | 89,3 % | **100 %** |
| pericia PERICIA_B | 96,7 % | **100 %** |
| cuento | 98,5 % | **100 %** |
