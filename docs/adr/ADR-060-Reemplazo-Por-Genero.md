...
Todo lo que hizo Anonly hasta hoy fue quitar o sustituir información. `[PERSONA 01]` revela menos que "Eta Gómez". `[MUJER 01]` revela menos que "Eta Gómez" pero **más que `[PERSONA 01]`**, y el atributo que agrega es una categoría sensible por sí misma.
