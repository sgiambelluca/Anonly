...
- **Bloqueado con un conflicto sin resolver** (ADR-176 §1): deshabilitado, con el motivo en una ranura
  fija debajo —*"Hay un choque sin resolver. Resolvelo para exportar."* y **"Resolver"**, igual al del
