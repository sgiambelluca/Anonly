...
- **Opciones, en este orden** (ADR-169 §10): Ver apariciones · Editar reemplazo… · Cambiar tipo… ·
  ...
  - **"Eliminar entidad"** (ADR-171) → `ConfirmDialog` que nombra la entidad y aclara que su dato
    ...
    «X» · Lo que marcaste («Z») ahora se oculta"*.
